...
function collect(options = {}) {
  ...
  // Run the analyzer-queries batch first when requested. Downstream
  // collectors can consume the bundle via opts.analyzer (docs-patterns
  // reads it for stale-docs lookup + entry-point filtering).
